...
5. **Document Root:** Select the destination folder (e.g., `/volume1/web/graphstation_frontend`).
...
3. **Document Root:** Select the API folder (e.g., `/volume1/web/graphstation_frontend/api`).
...
GRAPHSTATION_API_URL=http://192.168.0.x:5000/graphstation-api
...
_Note: If you have SSH access, ensure that the user has write permissions in the web folder._
